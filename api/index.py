...
SecretKey = "Z17BG6KYQOJZ9IHEGUEIGHU1HO6FOJ8JM1UNZ31H7K8UR6QUKE"

#😀
app_credentials_1 = 'OC|9655816024513815|36a679ab6e2c2879d038c6eb13e1eacb'

# 😝
app_credentials_2 = 'OC|9655816024513815|36a679ab6e2c2879d038c6eb13e1eacb'

# 😁
app_credentials_3 = 'OC|9655816024513815|36a679ab6e2c2879d038c6eb13e1eacb'
...
def photonauthenticate():
    if request.method.upper() == "GET":
        ...
        response = requests.post(
            url=f"https://5A724.playfabapi.com/Server/GetUserData",
            json={"PlayFabId": userId},
            headers={
                "X-SecretKey":
                "QP18WWB4Q6KMKFPCWODK3UWFDYB4AW5P6AOKC87BC4836U9GU9",
                "Content-Type": "application/json"
            })

        accountinfo = requests.post(
            url=f"https://5A724.playfabapi.com/Server/GetUserAccountInfo",
            json={"PlayFabId": userId},
            headers={
                "X-SecretKey":
                "QP18WWB4Q6KMKFPCWODK3UWFDYB4AW5P6AOKC87BC4836U9GU9",
...
def playfabauth():
    ...
    print("Received data at /api/playfabauthenticate:", data) # type: ignore
